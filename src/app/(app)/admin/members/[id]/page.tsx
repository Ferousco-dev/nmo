        ...
        <div className="card-premium p-6 sm:p-8 mb-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-baseline gap-2 min-w-0">
                ...
                {m.skool_handle && (
                  <a
                    ...
                    aria-label={`Open ${name}'s Skool profile`}
              ...
              {m.skool_handle && (
                <p className="text-xs text-ink-dim font-mono truncate">@{m.skool_handle}</p>
              )}
              <p className="text-xs text-ink-muted mt-1 truncate">{m.email}</p>
            </div>
          </div>
