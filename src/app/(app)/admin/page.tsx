...
import { Users, Ticket, ScrollText, ArrowRight, BookOpenText, Network } from 'lucide-react';
import { createClient } from '@/lib/supabase/server';
import { getT } from '@/lib/i18n/server';
import { BotSyncCard } from '@/components/admin/BotSyncCard';
import { IntegrationSettingsCard } from '@/components/admin/IntegrationSettingsCard';
...
export default async function AdminOverviewPage() {
  ...
  return (
        ...
        {/* Bot sync — manual trigger + recent run health */}
        <div className="mb-6">
          <BotSyncCard />
        </div>

        {/* Integrations — Apify token + Skool watcher creds */}
        <div className="mb-6">
